...
namespace Company.Model
{
    public class Employee
    {
        ...
        public static Employee FindInHistory() 
        {
            try
            {
        ...
        public static void GetSalary()
        {
            try
            {
                ...
                Console.WriteLine(employee.Position.Salary);
            }
            catch (Exception ex)
            {
                Console.WriteLine($"General error occured: {ex.Message}");
        ...
        private static Employee Find()
        {
            ...
            foreach (Employee employee in employees)
                if (employee.Name == name && (employee.Position.Name == posOrDep || employee.Department.Name == posOrDep))
                {
                    return employee;
                }
            return null;
        ...
        {
            return $"{Position} {Name} из {Department.Name} с {DateTime}";
        }
    }
}
